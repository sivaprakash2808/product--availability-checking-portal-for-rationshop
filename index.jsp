...
<%
    ...
    if (request.getParameter("btn") != null) {
        try {
            String query = "SELECT * FROM admin WHERE name = ? AND psw = ?";
            ...
            if (rs.next()) {
                // Login successful
                out.println("<script>alert('Welcome to admin home page');</script>");
                response.sendRedirect("adminhome.jsp");
            } else {
                // Login failed
                out.println("<script>alert('User Name or Password is wrong');</script>");
            }
        } catch (SQLException e) {
            e.printStackTrace();
            throw new ServletException("Database query error");
        }
    }
%>
...
<div class="style1" id="templatemo_header">
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <span class="style2 style17"><span class="style19">RATION PRODUCT AVAILABILITY CHECKING PORTAL</span></span>
    <p class="style5">&nbsp;</p>
    ...
    <div id="templatemo_content">
        ...
        <script src="js/chili/recipes.js" type="text/javascript"></script>
            ...
            <div class="project_content">
                ...
                <p align="justify">Project titled ?RATION PRODUCT AVAILABILITY CHECKING PORTAL is to digitalize the process followed in the ration shop.</p>
        ...
        <div id="content_panel">
            ...
            <div id="column_w610">
                ...
                <p>Project titled ?RATION PRODUCT AVAILABILITY CHECKING PORTAL is to digitalize the process followed in the ration shop. The ledger records are converted to digital records</a>.</p>
            ...
            <div id="column_w290">
            	...
            	<div class="header_02">Login</div>
                	...
                	<table width="284" height="153" border="0">
                      ...
                      <tr>
                        <td width="85" height="49"><span class="style3">User Name </span></td>
...
<div id="templatemo_footer_wrapper">
	...
	<div id="templatemo_footer">
	  <div class="section_w920">
        Copyright  2025 @ ration Management System</div>
        <div class="cleaner"></div>
  </div> <!-- end of footer -->
</div> <!-- end of footer -->
</body>
